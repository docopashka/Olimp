...
<body class="text-center">
    <?php
        ...
        $n = $n[0];
        $result = $mysql->query("SELECT `content`,`image`,`file` FROM `question` WHERE `id_stage` = '$id_stage'");
            ...
            <div id="questions">
                <div id="vopros1" style="display:block;">
                    ...
                    <div class="alert alert-secondary" role="alert">
                        <p><span id="v_1"></span> 
                            <br><a id="f_1" style="display:none;" href="" target= "_blank" download>Файл</a>
                            <div class="input-group">
                                <textarea class="form-control" id="z_1" rows="1"></textarea><br>
                                <input type="file" class="form-control" name="z[]" id="z_1" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                            </div>
                        </p>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer" style="align-self:center;">
                            <button type="submit" id="button" class="btn btn-primary" onclick="proverit3();">Да</button>
