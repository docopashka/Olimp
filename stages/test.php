<html>
<head>
    <title>Тренеровочный тест</title>
    <meta charset="utf-8">
...
<body class="text-center">
    ...
    <?php
        ...
        $n = $n[0];
        $result = $mysql->query("SELECT `content`,`image`,`answer` FROM `question` WHERE `id_stage` = '$id_stage'");
    ...
    <div class="card">
        <div class="card-body" id = "card-body">
            ...
            <div id="btn-toolbar" class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <button id="kn_pr" class="btn btn-lg btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Завершить</button>
            <div id="rezultat"></div>
            <button id="again" class="btn btn-lg btn-primary btn-block"style="display:none;" onclick="location.reload();">Пройти заново</button>
            <button id="out" class="btn btn-lg btn-primary btn-block"style="display:none;" onclick="window.location.href = '../profile.php';">Выйти</button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="align-self:center;">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="proverit2();">Да</button>
